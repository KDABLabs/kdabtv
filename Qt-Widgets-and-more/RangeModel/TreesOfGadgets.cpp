...
// Reported as a bug: https://bugreports.qt.io/browse/QTBUG-141885
...
{
    Q_GADGET
    Q_PROPERTY(QString region MEMBER m_region)
...
#if 0 // This is needed in Qt 6.10 (fixed in 6.11)
...
#if 0 // This is needed in Qt 6.10
namespace std {
template <>
